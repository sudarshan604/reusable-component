...
const RibbonBanner = () => {
  return (
    <div className="min-h-screen bg-blue-800 p-8 ">
      <div className="mx-auto bg-white rounded-xl relative shadow-xl h-80 w-80">
        <div className=" overflow-hidden w-36 aspect-square absolute -right-2 -top-2 rounded-md">
          ...
          <a
            href="#"
            className="bg-amber-300 block origin-bottom-right rotate-45 right-0  text-amber-700 tracking-wider uppercase w-square-diagonal absolute bottom-0 text-center py-1.5
             text-xs
              shadow-sm
             font-semibold"
          >
        ...
        <div className=" overflow-hidden w-36 aspect-square absolute -left-2 -top-2 rounded-md">
          ...
          <a
            href="#"
            className="bg-amber-300 block origin-bottom-left bottom-0 left-0 -rotate-45    text-amber-700 tracking-wider uppercase w-square-diagonal absolute  text-center py-1.5
             text-xs
              shadow-sm
             font-semibold"
          >
